...
namespace Ookly.Infrastructure.EntityFramework.Postgres.Migrations
{
    ...
    [Migration("20231103140456_Add_Filter_Pparent")]
    partial class Add_Filter_Pparent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ookly.Core.Entities.AdEntity.Ad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ookly.Core.Entities.AdEntity.AdProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ookly.Core.Entities.AdEntity.AdProperty", b =>
                {
                    b.HasOne("Ookly.Core.Entities.AdEntity.Ad", "Ad")
                        .WithMany("Properties")
                        .HasForeignKey("AdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
